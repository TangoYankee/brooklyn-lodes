...
nyc_nta_borders <- sf::st_read('data/nyc_2010_nta_borders.geojson') %>% sf::st_set_crs(2263)
...
## Infrastructure
nyc_boro_borders <- sf::st_read("./data/boro_boundaries.geojson") %>% sf::st_set_crs(2263)
major_roads <- sf::st_read("./data/DCM_ArterialsMajorStreets.geojson") %>% sf::st_set_crs(2263)
subways <- sf::st_read("./data/subway_lines.geojson") %>% sf::st_set_crs(2263)
```
