...
## The amount of time taked to travel by subway, car, or foot
...
driving_pred_low <- driving_predication - (2*driving_se)
driving_pred_high <- driving_predication + (2*driving_se)
