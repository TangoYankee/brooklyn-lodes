...
```{r, message=FALSE, echo=FALSE, results='hide', fig.cap="Global auto-correlation of job count using subway transit time for neighborhood wieghts"}
...
```{r, message=FALSE, echo=FALSE, results='hide', fig.cap="Global auto-correlation of job count using driving time for neighborhood wieghts"}
...
```{r, message=FALSE, echo=FALSE, results='hide', fig.cap="Global auto-correlation of job count using walking time for neighborhood wieghts"}
...
```{r, message=FALSE, echo=FALSE, results='hide', fig.cap="Global auto-correlation of job count using queens contiguity for neighborhood wieghts"}
