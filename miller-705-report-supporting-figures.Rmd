...
```{r, message=FALSE, echo=FALSE, fig.width = 10, fig.height = 13, fig.cap="Number of jobs in each NTA tract. Job count is calculated from the sum of all trips which end in that NTA. It is standardized by the total area of the NTA. It is also transformed with a natural log."}
...
```{r, message=FALSE, echo=FALSE, fig.width = 10, fig.height = 13, fig.cap="Boxplot for the number of commutes, factored by the number of subway lines used during the commute. Commutes are transformed by a natural log and standardized by area"}
...
```{r, message=FALSE, echo=FALSE, results='hide', fig.width=10, fig.height=6, fig.cap="Global auto-correlation of job count using subway transit time for neighborhood wieghts"}
...
```{r, message=FALSE, echo=FALSE, results='hide', fig.width=10, fig.height=6, fig.cap="Global auto-correlation of job count using driving time for neighborhood wieghts"}
...
```{r, message=FALSE, echo=FALSE, results='hide', fig.width=10, fig.height=6,fig.cap="Global auto-correlation of job count using walking time for neighborhood wieghts"}
...
```{r, message=FALSE, echo=FALSE, results='hide', fig.width=10, fig.height=6, fig.cap="Global auto-correlation of job count using queens contiguity for neighborhood wieghts"}
...
```{r, message=FALSE, echo=FALSE, warning = FALSE, fig.width=10, fig.height=13, fig.cap="Local auto-correlation for job count of NTAs. Each map utilizes a unique neighborhood weighting. Top left uses queen contiguity. Top right uses driving time in traffic and is overlayed with major roads. Bottom left uses walking time. Bottom right uses transit time on the subway and is overlayed with the subway network."}
